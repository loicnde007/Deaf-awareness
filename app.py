    ...
    if os.path.exists(DB_FILE):
        ...
        initial_data = {
            "Leçon 1 - LSF": {
                ...
                "hide_revision": True,
                "quiz_questions": [
                    {"id": 1, "question": "Quel mot correspond à cette image", "options": ["Garage", "Cuisine", "Grenier", "Balcon"], "answer": "Balcon", "image": "images/signe_balcon.jpg"},
                    {"id": 2, "question": "Quel mot correspond à ce geste", "options": ["Maison", "Cuisine", "Jardin", "Cave"], "answer": "Maison", "image": "images/signe_maison.jpg"},
                    {"id": 3, "question": "Quel mot correspond à cette image", "options": ["Bureau", "Chambre", "Salon", "Maison"], "answer": "Bureau", "image": "images/signe_bureau.jpg"},
                    {"id": 4, "question": "Quel mot correspond à cette image", "options": ["Salle de bain", "Grenier", "Jardin", "Cave"], "answer": "Jardin", "image": "images/signe_jardin.jpg"},
                    {"id": 5, "question": "Quel mot correspond à ce geste", "options": ["Garage", "Bureau", "Chambre", "Salon"], "answer": "Garage", "image": "images/signe_garage.jpg"},
                    {"id": 6, "question": "Quel mot correspond à cette image", "options": ["Maison", "Cuisine", "Grenier", "Balcon"], "answer": "Grenier", "image": "images/signe_grenier.jpg"}
                ]
            },
            "Leçon 1 - Français": {
                "titre": "L' alphabet ",
                ...
                "hide_revision": True,
                "quiz_questions": [
                    {"id": 1, "question": "Quel lettre correspond à cette image", "options": ["C", "A", "G", "D"], "answer": "A", "image": "images/A1.jpg"},
                    {"id": 2, "question": "Quel lettre correspond à cette image", "options": ["C", "E", "F", "I"], "answer": "C", "image": "images/C1.jpg"},
                    {"id": 3, "question": "Quel lettre correspond à cette image", "options": ["L", "B", "M", "D"], "answer": "L", "image": "images/L1.jpg"},
                    {"id": 4, "question": "Quel lettre correspond à cette image", "options": ["C", "S", "O", "F"], "answer": "O", "image": "images/O1.jpg"},
                    {"id": 5, "question": "Quel lettre correspond à cette image", "options": ["W", "B", "R", "I"], "answer": "R", "image": "images/R1.jpg"},
                    {"id": 6, "question": "Quel lettre correspond à cette image", "options": ["C", "K", "N", "D"], "answer": "K", "image": "images/K1.jpg"}
                ]
            }
        }
...
def render_director_space():
    ...
    if password == "1234":
        ...
        with st.form("new_content_form", clear_on_submit=True):
            ...
            with col2:
                l_video = st.text_input("Lien de la vidéo :", value="videos/defaut.mp4")
...
def render_translator():
    ...
    if text_input:
        ...
        for word in words:
            fichiers_possibles = [
                (f"videos/{word}.mp4", "video"),
                (f"images/{word}.mp4", "video"),
                (f"images/{word}.jpg", "image"),
                (f"images/{word}.png", "image"),
                (f"images/{word}.jpeg", "image")
            ]
            trouve = False
                ...
                if word.lower() in noms_personnes:
                    ...
                    for lettre in word.lower():
                        ...
                        for ext in ["jpg", "png", "jpeg"]:
                            chemin_test = f"images/{lettre}.{ext}"
            ...
            with st.form("forum_form", clear_on_submit=True):
                ...
                if st.form_submit_button("Publier le sujet"):
                    if titre.strip() and contenu_forum.strip():
                        ...
                        if video_lsf:
                            import uuid
                            video_path = f"videos/forum_{uuid.uuid4().hex[:8]}.mp4"
